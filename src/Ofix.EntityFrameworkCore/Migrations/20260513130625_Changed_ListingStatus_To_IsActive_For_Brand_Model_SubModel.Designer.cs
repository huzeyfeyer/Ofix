...
namespace Ofix.Migrations
{
    ...
    [Migration("20260513130625_Changed_ListingStatus_To_IsActive_For_Brand_Model_SubModel")]
    partial class Changed_ListingStatus_To_IsActive_For_Brand_Model_SubModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ofix.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("Ofix.Brands.Brand", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Ofix.CarListingImages.CarListingImage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppCarListingImages", (string)null);
                });
            ...
            modelBuilder.Entity("Ofix.FeatureCategories.FeatureCategory", b =>
                {
                    ...
                    b.ToTable("AppFeatureCategories", (string)null);
                });
            ...
            modelBuilder.Entity("Ofix.Models.Model", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Ofix.SubModels.SubModel", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppSubModels", (string)null);
                });
            ...
            modelBuilder.Entity("Ofix.CarListingImages.CarListingImage", b =>
                {
                    b.HasOne("Ofix.CarListings.CarListing", "CarListing")
                        .WithMany("Images")
            ...
            modelBuilder.Entity("Ofix.CarListings.CarListing", b =>
                {
                    b.HasOne("Ofix.Brands.Brand", "Brand")
                        .WithMany()
                        .HasForeignKey("BrandId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Ofix.Models.Model", "Model")
                        .WithMany()
                        .HasForeignKey("ModelId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Ofix.SubModels.SubModel", "SubModel")
                        .WithMany()
            ...
            modelBuilder.Entity("Ofix.Features.Feature", b =>
                {
                    b.HasOne("Ofix.FeatureCategories.FeatureCategory", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Ofix.Models.Model", b =>
                {
                    b.HasOne("Ofix.Brands.Brand", null)
                        .WithMany()
                        .HasForeignKey("BrandId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Ofix.SubModels.SubModel", b =>
                {
                    b.HasOne("Ofix.Models.Model", null)
                        .WithMany()
                        .HasForeignKey("ModelId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
