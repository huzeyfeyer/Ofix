$(function () {
    ...
    function loadModelsByBrand(brandId) {
        ...
        $.ajax({
            url: '/CarListings/Create?handler=ModelsByBrand&brandId=' + brandId,
            type: 'GET',
    ...
    function loadSubModelsByModel(modelId) {
        ...
        $.ajax({
            url: '/CarListings/Create?handler=SubModelsByModel&modelId=' + modelId,
            type: 'GET',
            success: function (data) {
                $.each(data, function (index, item) {
    ...
    if (priceInput.val() === '0') {
        ...
        priceInput.val(formatThousands(priceInput.val()));
    }
